 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg * 3600 + min * 60 + sec) / 206264.8
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (((initial * percent * 0.01 + initial) +
        +((initial * percent * 0.01 + initial) * percent * 0.01)) * percent * 0.01) +
        +((initial * percent * 0.01 + initial) + ((initial * percent * 0.01 + initial) * percent * 0.01))
